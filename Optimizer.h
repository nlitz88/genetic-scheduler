...
private:
    ...
    int ruleFitnesses[8];
    std::string ruleNames[8] {"Rule_TimeConflict", "Rule_CampusTime", "Rule_NextDay", "Rule_TwoEvenings", "Rule_BackToBack", "Rule_AroundCommon", "Rule_ClassesPerDay", "Rule_LongClassesPerDay"};
